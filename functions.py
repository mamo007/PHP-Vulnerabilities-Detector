...
# Replace the nth occurrence of a string. Ex: mystring.replace("substring", 2nd)
...
def display(path, payload, vulnerability, line, declaration_text, declaration_line, colored, occurrence, plain):
    ...
    Description = "{}Description       \n{}{}{}".format('' if plain else '\033[1m', '' if plain else '\033[92m', payload[3], '' if plain else '\033[0m')
    Vuln_Patch  = "{}Patch             \n{}{}{}".format('' if plain else '\033[1m', '' if plain else '\033[92m', payload[4], '' if plain else '\033[0m')
    ...
    # Display a short discrption of the vulnerability
    if(payload[3] != ""):
        print("{}".format(Description))

    print("")

    # Display a short patch of the vulnerability
    if(payload[4] != ""):
        print("{}".format(Vuln_Patch))
